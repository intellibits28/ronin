...
execute_process(
  COMMAND "/data/data/com.termux/files/usr/bin/git" --git-dir=.git show-ref "v2.0.8"
  WORKING_DIRECTORY "/data/data/com.termux/files/home/play-ground/ronin/build_check/_deps/flatbuffers-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/data/data/com.termux/files/home/play-ground/ronin/build_check/_deps/flatbuffers-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/data/data/com.termux/files/home/play-ground/ronin/build_check/_deps/flatbuffers-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
