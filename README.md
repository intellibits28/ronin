...
![Version](https://img.shields.io/badge/version-4.7.26.05.26--HARDENED-blue?style=flat-square)
![Platform](https://img.shields.io/badge/platform-Android%20(SD778G%2B)-green?style=flat-square)
![License](https://img.shields.io/badge/license-MIT-lightgrey?style=flat-square)

**Ronin Kernel** is a sovereign, modular AI agent runtime optimized for Android (Snapdragon 778G+). It utilizes the **Hardened v3.3 Production Architecture**, bridging pure C++20 reasoning spines with Kotlin hardware nodes via a zero-lag **Native Direct Bridge** for secure, high-performance edge intelligence.

---

## 📖 Description
Ronin Kernel v3.3 introduces advanced **User-Centric Controls**, featuring dynamic **T,P,K Sampling** and a **Thinking Toggle**. It ensures **Streaming Stability** by eliminating empty bubbles and providing real-time reasoning indicators.

### Key Features (Hardened v3.3)
*   **Advanced Sampling (T,P,K):** Sliders for Temperature, Top-K, and Top-P provide granular control over Gemma 4's reasoning.
*   **Thinking Toggle:** Choose to show or hide the internal reasoning process (`[THINK]`) via a simple switch.
*   **Streaming Stability:** Bubbles display "Ronin is reasoning..." status immediately, ensuring a responsive UX even during complex prefill.
*   **Real-time Token Streaming:** Watch Ronin think and reply token-by-token with zero-wait UI updates.
*   **AI Edge Gallery UI:** Redesigned navigation drawer for History, Settings, and Editable System Prompt.
