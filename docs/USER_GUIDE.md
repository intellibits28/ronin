...
8. [ရေရှည်မှတ်ဉာဏ်နှင့် လုံခြုံရေး Vault (Long-Term Memory & Vault)](#၈-ရေရှည်မှတ်ဉာဏ်နှင့်-လုံခြုံရေး-vault-long-term-memory--vault)
9. [မှတ်ဉာဏ် Backup ရယူခြင်းနှင့် အသစ်ပြန်တင်ခြင်း (Disaster Recovery & Backup)](#၉-မှတ်ဉာဏ်-backup-ရယူခြင်းနှင့်-အသစ်ပြန်တင်ခြင်း-disaster-recovery--backup)
10. [အမြန်သုံး Command များ (Slash Commands Reference)](#၁၀-အမြန်သုံး-command-များ-slash-commands-reference)
11. [မကြာခဏမေးလေ့ရှိသော မေးခွန်းများနှင့် ဖြေရှင်းနည်းများ (FAQ & Troubleshooting)](#၁၁-မကြာခဏမေးလေ့ရှိသော-မေးခွန်းများနှင့်-ဖြေရှင်းနည်းများ-faq--troubleshooting)
...
## ၈။ ရေရှည်မှတ်ဉာဏ်နှင့် လုံခြုံရေး Vault (Long-Term Memory & Vault)
...
## ၉။ မှတ်ဉာဏ် Backup ရယူခြင်းနှင့် အသစ်ပြန်တင်ခြင်း (Disaster Recovery & Backup)
...
## ၁၀။ အမြန်သုံး Command များ (Slash Commands Reference)
...
## ၁၁။ မကြာခဏမေးလေ့ရှိသော မေးခွန်းများနှင့် ဖြေရှင်းနည်းများ (FAQ & Troubleshooting)
